...
(
    ...
    nick_name character varying(100) COLLATE pg_catalog."default",
    birth_date date,
    profile_photo_url text COLLATE pg_catalog."default",
    phone_number character varying(20) COLLATE pg_catalog."default",
    my_team character varying(50) COLLATE pg_catalog."default",
    social_provider character varying(50) COLLATE pg_catalog."default",
