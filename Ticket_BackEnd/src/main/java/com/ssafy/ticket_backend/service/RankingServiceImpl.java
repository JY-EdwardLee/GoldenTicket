...
public class RankingServiceImpl implements RankingService {
    ...
    public List<UserRankingResponse> getUserRanking() {
        List<UserRankingResponse> userRankingList = new ArrayList<>();
    ...
    public List<TeamRankingResponse> getTeamRanking() {
        List<TeamRankingResponse> teamRankingList = new ArrayList<>();
        teamRankingList = rankingMapper.selectTeamRanking();
